...
const (
	// Label holds the string label denoting the aclentry type in the database.
	Label = "acl_entry"
	...
	EdgeFile = "file"
	// Table holds the table name of the aclentry in the database.
	Table = "acl_entries"
	// FileTable is the table that holds the file relation/edge.
	FileTable = "acl_entries"
...
// Columns holds all SQL columns for aclentry fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
const (
	...
	SubjectTypeEveryone  SubjectType = "everyone"
)
...
func SubjectTypeValidator(st SubjectType) error {
	switch st {
	case SubjectTypeUser, SubjectTypeGroup, SubjectTypeAnonymous, SubjectTypeEveryone:
		return nil
	default:
		return fmt.Errorf("aclentry: invalid enum value for subject_type field: %q", st)
	}
}

// OrderOption defines the ordering options for the AclEntry queries.
